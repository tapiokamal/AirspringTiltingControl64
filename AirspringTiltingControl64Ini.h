#pragma once
//
// Generated on 2021/02/05 by inimoni 
//
...
#ifndef AIRSPRINGTILTINGCONTROL64INI_H
#define AIRSPRINGTILTINGCONTROL64INI_H
...
/**
    AirspringTiltingControl64.ini input output class.
*/
class AirspringTiltingControl64Ini
{
public:

    AirspringTiltingControl64Ini(string_t fname = _T(""))
    {
        initFileName = _T("./AirspringTiltingControl64.ini"); //Default file.    
        init();
        load(fname);
    }
...
protected:
    ...
    bool iniRW(string_t f, int r)
    {
        ...
        s = _T("Values");
        inimoni::inirw(r, f, s, _T("a                "), Values.a);
        inimoni::inirw(r, f, s, _T("b                "), Values.b);
        inimoni::inirw(r, f, s, _T("d                "), Values.d);
        return true;
    }
...
typedef AirspringTiltingControl64Ini AirspringTiltingControl64File; //êVãåå›ä∑
